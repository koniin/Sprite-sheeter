...
namespace SpriteSheeter.Lib {
    public class CommandFileParser {
        ...
        public CommandFileParser(SpriteSheetPacker spriteSheetPacker, UserSettings userSettings, ExportFileTypeFactory exportFileTypeFactory) {
            _spriteSheetPacker = spriteSheetPacker;
            _userSettings = userSettings;
            _exportFileFactory = exportFileTypeFactory;
        }
